...
public class Found extends BmobObject implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4662371016841056526L;
	/**
	 * Found entity,每个列表item内容
	 * 
	 * @author jason
	 * @date 2015-8-13
	 */
	...
	public String toString() {
		return "Found [author=" + author + ", content=" + content
