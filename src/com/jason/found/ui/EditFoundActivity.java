...
import com.jason.found.utils.CacheUtils;
...
public class EditFoundActivity extends BasePageActivity implements
		OnClickListener {
	...
	private void publish(final String commitContent) {
		...
		// final BmobFile figureFile = new BmobFile(Detail.class, new
		// File(targeturl));
		...
		figureFile.upload(mContext, new UploadFileListener() {
			...
			public void onSuccess() {
				...
				LogUtils.i(
						TAG,
						"上传文件成功。"
								+ figureFile.getFileUrl(EditFoundActivity.this));
	...
	private void publishWithoutFigure(final String commitContent,
		...
		// detail.setAuthor(user);
		// detail.setContent(commitContent);
		// if (figureFile != null) {
		// detail.setContentfigureurl(figureFile);
		// }
		// detail.setLove(0);
		// detail.setHate(0);
		// detail.setShare(0);
		// detail.setComment(0);
		// detail.setPass(true);
		// detail.save(mContext, new SaveListener() {
		//
		// @Override
		// public void onSuccess() {
		// // TODO Auto-generated method stub
		// ActivityUtil.show(EditLostActivity.this, "发布成功！");
		// LogUtils.i(TAG, "创建成功。");
		// setResult(RESULT_OK);
		// finish();
		//
		...
		// public void onFailure(int arg0, String arg1) {
		// // TODO Auto-generated method stub
		// ActivityUtil.show(EditLostActivity.this, "发布失败！yg" + arg1);
		...
		found.setContent(commitContent);
		if (figureFile != null) {
			found.setContentfigureurl(figureFile);
		}
		found.setLove(0);
		found.setHate(0);
		found.setShare(0);
		...
		found.save(mContext, new SaveListener() {
			...
			public void onSuccess() {
				// TODO Auto-generated method stub
				ActivityUtil.show(EditFoundActivity.this, "发布成功！");
				LogUtils.i(TAG, "创建成功。");
				setResult(RESULT_OK);
				finish();
			...
			public void onFailure(int arg0, String arg1) {
				// TODO Auto-generated method stub
				ActivityUtil.show(EditFoundActivity.this, "发布失败！yg" + arg1);
				LogUtils.i(TAG, "创建失败。" + arg1);
			}
		});
	}
