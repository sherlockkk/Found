...
import com.jason.found.utils.NetworkUtil;
 ...
 * @date 2015-8-16 TODO
 * 
 *       实现QQ好友以及Qzone分享一键完成 usage:1.按opensdk说明文档配置好AndroidManifest.xml
...
public class TencentShare implements TencentShareConstants {
	...
	private class BaseUiListener implements IUiListener {
		...
		public void onError(UiError e) {
			...
			LogUtils.i("QQ", "onError----" + "code:" + e.errorCode + ", msg:"
	...
	private class BaseApiListener implements IRequestListener {
		...
		public void onConnectTimeoutException(ConnectTimeoutException arg0) {
			LogUtils.i("IRequestListener.onConnectTimeoutException:",
					arg0.getMessage());
		...
		public void onSocketTimeoutException(SocketTimeoutException arg0) {
			LogUtils.i("IRequestListener.SocketTimeoutException:",
					arg0.getMessage());
		}
